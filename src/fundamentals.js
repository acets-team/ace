...
class Fundamental {
   ...
   * @param {'solid' | 'zod' | 'valibot' | 'turso' | 'agGrid' | 'cf' | 'markdownIt' | 'brevo' | 'vanilla' | 'chartjs' | 'hljs'} pluginName - Name of plugin
...
export const fundamentals = new Map([
  ...
  ['markdownIt', new Fundamental('ts', 'markdownIt', 'helper')],
  ['markdownItDynamic', new Fundamental('tsx', 'markdownIt', 'copy')],
  ['markdownItStatic', new Fundamental('tsx', 'markdownIt', 'copy')],
